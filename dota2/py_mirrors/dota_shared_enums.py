...
class DOTA_GameMode(betterproto.Enum):
...
class DOTA_GameState(betterproto.Enum):
...
class DOTA_GC_TEAM(betterproto.Enum):
...
class Fantasy_Roles(betterproto.Enum):
...
class Fantasy_Scoring(betterproto.Enum):
...
class Fantasy_Team_Slots(betterproto.Enum):
    FANTASY_SLOT_NONE = 0
    FANTASY_SLOT_CORE = 1
...
class Fantasy_Selection_Mode(betterproto.Enum):
...
class Fantasy_Gem_Type(betterproto.Enum):
...
class DOTA_CM_PICK(betterproto.Enum):
    DOTA_CM_RANDOM = 0
    DOTA_CM_GOOD_GUYS = 1
    DOTA_CM_BAD_GUYS = 2
...
class DOTA_BOT_MODE(betterproto.Enum):
...
class DOTA_COMBATLOG_TYPES(betterproto.Enum):
...
class CMsgDOTACombatLogEntry(betterproto.Message):
    type: "DOTA_COMBATLOG_TYPES" = betterproto.enum_field(1)
