...
# sources: enums_clientserver.proto
...
class EClientPersonaStateFlag(betterproto.Enum):
...
class EMsgClanAccountFlags(betterproto.Enum):
...
class ESteamReviewScore(betterproto.Enum):
...
class ECodecUsagePlatform(betterproto.Enum):
...
class ECodecUsageReason(betterproto.Enum):
