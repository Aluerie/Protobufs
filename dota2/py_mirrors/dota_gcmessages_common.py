...
class ENewBloomGiftingResponse(betterproto.Enum):
...
class CMsgServerToGCRequestPlayerRecentAccomplishmentsResponseEResponse(
    betterproto.Enum
):
    k_eInternalError = 0
    k_eSuccess = 1
...
class CMsgClientToGCDotaLabsFeedbackResponseEResponse(betterproto.Enum):
    k_eInternalError = 0
    k_eSuccess = 1
    k_eTooBusy = 2
    k_eDisabled = 3
...
class CDotaMsg_PredictionResultPredictionEResult(betterproto.Enum):
...
class CSODOTAGameAccountClient(betterproto.Message):
    ...
    curr_all_hero_challenge_id: int = betterproto.int32_field(67)
    ...
    role_handicaps: List[
        "CSODOTAGameAccountClientRoleHandicap"
    ] = betterproto.message_field(115)
    event_mode_recent_time: int = betterproto.uint32_field(120)
    mmr_recalibration_time: int = betterproto.uint32_field(121)
    banned_hero_ids: List[int] = betterproto.int32_field(123)
...
class CMsgLobbyFeaturedGamemodeProgress(betterproto.Message):
    accounts: List[
        "CMsgLobbyFeaturedGamemodeProgressAccountProgress"
...
class CMatchClip(betterproto.Message):
    ...
    hero_id: int = betterproto.int32_field(6)
...
class CMsgGCGetPlayerCardItemInfoResponse(betterproto.Message):
    player_card_infos: List[
        "CMsgGCGetPlayerCardItemInfoResponsePlayerCardInfo"
    ] = betterproto.message_field(1)
...
class CMsgDOTAProfileCard(betterproto.Message):
    ...
    event_level: int = betterproto.uint32_field(26)
...
class CSODOTAPlayerChallenge(betterproto.Message):
    ...
    hero_id: int = betterproto.int32_field(17)
...
class CMsgDOTARealtimeGameStats(betterproto.Message):
    ...
    buildings: List[
        "CMsgDOTARealtimeGameStatsBuildingDetails"
...
class CMsgDOTARealtimeGameStatsTeamDetails(betterproto.Message):
    ...
    players: List["CMsgDOTARealtimeGameStatsPlayerDetails"] = betterproto.message_field(
        6
    )
...
class CMsgDOTARealtimeGameStatsPlayerDetails(betterproto.Message):
    ...
    heroid: int = betterproto.int32_field(5)
    ...
    abilities: List[
        "CMsgDOTARealtimeGameStatsAbilityDetails"
    ...
    stashitems: List[
        "CMsgDOTARealtimeGameStatsItemDetails"
    ] = betterproto.message_field(44)
    itemshoppinglist: List[
        "CMsgDOTARealtimeGameStatsItemDetails"
    ] = betterproto.message_field(45)
    levelpoints: List[
        "CMsgDOTARealtimeGameStatsAbilityList"
    ] = betterproto.message_field(46)
    hero_to_hero_stats: List[
        "CMsgDOTARealtimeGameStatsHeroToHeroStats"
...
class CMsgDOTARealtimeGameStatsPickBanDetails(betterproto.Message):
    hero: int = betterproto.int32_field(1)
    team: int = betterproto.uint32_field(2)
...
class CMsgDOTARealtimeGameStatsMatchDetails(betterproto.Message):
    ...
    picks: List["CMsgDOTARealtimeGameStatsPickBanDetails"] = betterproto.message_field(
        10
    )
    bans: List["CMsgDOTARealtimeGameStatsPickBanDetails"] = betterproto.message_field(
        11
    )
    kills: List["CMsgDOTARealtimeGameStatsKillDetails"] = betterproto.message_field(12)
    broadcasters: List[
        "CMsgDOTARealtimeGameStatsBroadcasterDetails"
...
class CMsgDOTARealtimeGameStatsGraphDataTeamLocationStats(betterproto.Message):
    loc_stats: List[
        "CMsgDOTARealtimeGameStatsGraphDataLocationStats"
    ] = betterproto.message_field(1)
...
class CMsgDOTARealtimeGameStatsTerse(betterproto.Message):
    ...
    teams: List[
        "CMsgDOTARealtimeGameStatsTerseTeamDetails"
    ] = betterproto.message_field(2)
    buildings: List[
        "CMsgDOTARealtimeGameStatsTerseBuildingDetails"
    ] = betterproto.message_field(3)
...
class CMsgDOTARealtimeGameStatsTerseTeamDetails(betterproto.Message):
    ...
    players: List[
        "CMsgDOTARealtimeGameStatsTersePlayerDetails"
    ] = betterproto.message_field(6)
...
class CMsgDOTARealtimeGameStatsTerseMatchDetails(betterproto.Message):
    ...
    picks: List[
        "CMsgDOTARealtimeGameStatsTersePickBanDetails"
...
class CMsgInGamePrediction(betterproto.Message):
    ...
    query_values: List[
        "CMsgInGamePredictionQueryKeyValues"
    ] = betterproto.message_field(9)
    answer_resolution_type: "CMsgInGamePredictionEResolutionTypeT" = (
...
class CMsgDOTASeasonPredictions(betterproto.Message):
    predictions: List[
        "CMsgDOTASeasonPredictionsPrediction"
    ] = betterproto.message_field(1)
...
class CMsgDOTASeasonPredictionsPrediction(betterproto.Message):
    type: "CMsgDOTASeasonPredictionsPredictionEPredictionType" = betterproto.enum_field(
        1
    )
    ...
    answer_type: "CMsgDOTASeasonPredictionsPredictionEAnswerType" = (
        betterproto.enum_field(8)
    )
    answer_id: int = betterproto.uint32_field(9)
    answers: List[
        "CMsgDOTASeasonPredictionsPredictionAnswers"
    ...
    league_node_id: int = betterproto.uint32_field(20)
...
class CMsgAvailablePredictions(betterproto.Message):
    match_predictions: List[
        "CMsgAvailablePredictionsMatchPrediction"
    ] = betterproto.message_field(1)
...
class CMsgDOTAMatch(betterproto.Message):
    ...
    broadcaster_channels: List[
        "CMsgDOTAMatchBroadcasterChannel"
...
class CMsgDOTAMatchPlayer(betterproto.Message):
    ...
    custom_game_data: "CMsgDOTAMatchPlayerCustomGameData" = betterproto.message_field(
        50
    )
    ...
    hero_damage_received: List[
        "CMsgDOTAMatchPlayerHeroDamageReceived"
    ] = betterproto.message_field(67)
    hero_damage_dealt: List[
        "CMsgDOTAMatchPlayerHeroDamageReceived"
    ] = betterproto.message_field(79)
...
class CMsgDOTAMatchBroadcasterChannel(betterproto.Message):
    ...
    broadcaster_infos: List["CMsgDOTAMatchBroadcasterInfo"] = betterproto.message_field(
        3
    )
...
class CMsgMatchConsumableUsage(betterproto.Message):
    player_consumables_used: List[
        "CMsgMatchConsumableUsagePlayerUsage"
    ] = betterproto.message_field(1)
...
class CMsgMatchEventActionGrants(betterproto.Message):
    player_grants: List[
        "CMsgMatchEventActionGrantsPlayerGrants"
    ] = betterproto.message_field(1)
...
class CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse(betterproto.Message):
    result: "CMsgServerToGCRequestPlayerRecentAccomplishmentsResponseEResponse" = (
...
class CMsgGCtoGCAssociatedExploiterAccountInfoResponse(betterproto.Message):
    accounts: List[
        "CMsgGCtoGCAssociatedExploiterAccountInfoResponseAccount"
    ] = betterproto.message_field(1)
...
class CMsgGameDataSpecialValues(betterproto.Message):
    ...
    facet_bonus: "CMsgGameDataFacetAbilityBonus" = betterproto.message_field(9)
    required_facet: str = betterproto.string_field(10)


@dataclass
class CMsgGameDataFacetAbilityBonus(betterproto.Message):
    name: str = betterproto.string_field(1)
...
class CMsgGameDataAbilityOrItem(betterproto.Message):
    ...
    facets_loc: List[str] = betterproto.string_field(11)
    ...
    ability_is_innate: bool = betterproto.bool_field(64)
...
@dataclass
class CMsgGameDataAbilityOrItemList(betterproto.Message):
...
class CMsgGameDataHero(betterproto.Message):
    ...
    facets: List["CMsgGameDataHeroFacet"] = betterproto.message_field(43)
    ...
    facet_abilities: List["CMsgGameDataAbilityOrItemList"] = betterproto.message_field(
        42
    )


@dataclass
class CMsgGameDataHeroFacet(betterproto.Message):
    color: int = betterproto.uint32_field(1)
    title_loc: str = betterproto.string_field(2)
    description_loc: str = betterproto.string_field(3)
    name: str = betterproto.string_field(4)
    icon: str = betterproto.string_field(5)
    gradient_id: int = betterproto.int32_field(6)
...
class CMsgGameDataItemAbilityList(betterproto.Message):
    itemabilities: List[
        "CMsgGameDataItemAbilityListItemAbilityInfo"
    ] = betterproto.message_field(1)
...
class CMsgGameDataItemAbilityListItemAbilityInfo(betterproto.Message):
    ...
    is_pregame_suggested: bool = betterproto.bool_field(6)
    is_earlygame_suggested: bool = betterproto.bool_field(7)
    is_lategame_suggested: bool = betterproto.bool_field(8)
    recipes: List[
        "CMsgGameDataItemAbilityListItemAbilityInfoRecipe"
    ] = betterproto.message_field(9)


@dataclass
class CMsgGameDataItemAbilityListItemAbilityInfoRecipe(betterproto.Message):
    items: List[int] = betterproto.int32_field(1)
...
@dataclass
class CMsgDOTAClaimEventActionResponseOverworldTokenRewardData(betterproto.Message):
    tokens: List[
        "CMsgDOTAClaimEventActionResponseOverworldTokenRewardDataTokenQuantity"
    ] = betterproto.message_field(1)


@dataclass
class CMsgDOTAClaimEventActionResponseOverworldTokenRewardDataTokenQuantity(
    betterproto.Message
):
...
class CMsgDOTAClaimEventActionResponseGrantedRewardData(betterproto.Message):
    ...
    action_id: int = betterproto.uint32_field(5)


@dataclass
class CMsgClientToGCDotaLabsFeedback(betterproto.Message):
    language: int = betterproto.uint32_field(1)
    feedback_item: int = betterproto.uint32_field(2)
    feedback: str = betterproto.string_field(3)


@dataclass
class CMsgClientToGCDotaLabsFeedbackResponse(betterproto.Message):
    response: "CMsgClientToGCDotaLabsFeedbackResponseEResponse" = (
        betterproto.enum_field(1)
    )


@dataclass
class CDotaMsg_PredictionResult(betterproto.Message):
    account_id: int = betterproto.uint32_field(1)
    match_id: int = betterproto.uint64_field(2)
    correct: bool = betterproto.bool_field(3)
    predictions: List[
        "CDotaMsg_PredictionResultPrediction"
    ] = betterproto.message_field(4)


@dataclass
class CDotaMsg_PredictionResultPrediction(betterproto.Message):
    item_def: int = betterproto.uint32_field(1)
    num_correct: int = betterproto.uint32_field(2)
    num_fails: int = betterproto.uint32_field(3)
    result: "CDotaMsg_PredictionResultPredictionEResult" = betterproto.enum_field(4)
