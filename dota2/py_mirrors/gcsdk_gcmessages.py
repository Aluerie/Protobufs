...
class CMsgSOMultipleObjects(betterproto.Message):
    objects_modified: List[
        "CMsgSOMultipleObjectsSingleObject"
...
class CGCToGCMsgMasterStartupComplete(betterproto.Message):
    gc_info: List["CGCToGCMsgMasterStartupCompleteGCInfo"] = betterproto.message_field(
        1
    )
...
class CMsgGCUpdateSubGCSessionInfo(betterproto.Message):
    updates: List["CMsgGCUpdateSubGCSessionInfoCMsgUpdate"] = betterproto.message_field(
        1
    )
...
class CMsgClientWelcome(betterproto.Message):
    ...
    outofdate_subscribed_caches: List[
        "CMsgSOCacheSubscribed"
    ] = betterproto.message_field(3)
    uptodate_subscribed_caches: List[
...
class CMsgGCToGCSOCacheSubscribe(betterproto.Message):
    ...
    have_versions: List[
        "CMsgGCToGCSOCacheSubscribeCMsgHaveVersions"
    ] = betterproto.message_field(4)
...
@dataclass
class CWorkshop_PopulateItemDescriptions_RequestSingleItemDescription(
    betterproto.Message
):
...
@dataclass
class CWorkshop_PopulateItemDescriptions_RequestItemDescriptionsLanguageBlock(
    betterproto.Message
):
    language: str = betterproto.string_field(1)
    descriptions: List[
        "CWorkshop_PopulateItemDescriptions_RequestSingleItemDescription"
    ] = betterproto.message_field(2)
...
class CWorkshop_SetItemPaymentRules_Request(betterproto.Message):
    ...
    partner_accounts: List[
        "CWorkshop_SetItemPaymentRules_RequestPartnerItemPaymentRule"
    ] = betterproto.message_field(4)
    validate_only: bool = betterproto.bool_field(5)
    make_workshop_files_subscribable: bool = betterproto.bool_field(6)
    associated_workshop_file_for_direct_payments: "CWorkshop_SetItemPaymentRules_RequestWorkshopDirectPaymentRule" = betterproto.message_field(
        7
    )
...
@dataclass
class CWorkshop_SetItemPaymentRules_RequestWorkshopDirectPaymentRule(
    betterproto.Message
):
    workshop_file_id: int = betterproto.uint64_field(1)
...
class CCommunity_GetClanAnnouncements_Response(betterproto.Message):
    ...
    announcements: List["CCommunity_ClanAnnouncementInfo"] = betterproto.message_field(
        3
    )
