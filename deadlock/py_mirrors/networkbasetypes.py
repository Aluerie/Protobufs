...
class CNETMsg_Tick(betterproto.Message):
    ...
    legacy_host_loss: int = betterproto.uint32_field(7)
    ...
    host_frame_dropped_pct_x10: int = betterproto.uint32_field(12)
    host_frame_irregular_arrival_pct_x10: int = betterproto.uint32_field(13)
