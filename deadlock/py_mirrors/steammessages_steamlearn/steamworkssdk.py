...
class CMsgSteamLearn_InferenceMetadata_Response(betterproto.Message):
    ...
    sequence_tables: List[
        "CMsgSteamLearn_InferenceMetadata_ResponseSequenceTable"
    ] = betterproto.message_field(9)
    kmeans: List[
        "CMsgSteamLearn_InferenceMetadata_ResponseKMeans"
    ] = betterproto.message_field(6)
    app_info: List[
        "CMsgSteamLearn_InferenceMetadata_ResponseAppInfoEntry"
...
@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseSequenceTable(betterproto.Message):
    name: str = betterproto.string_field(1)
    map_values: List[
        "CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableMapValuesEntry"
    ] = betterproto.message_field(2)
    map_mappings: List[
        "CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableMapMappingsEntry"
    ] = betterproto.message_field(3)
    total_count: int = betterproto.uint64_field(4)


@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableEntry(betterproto.Message):
    values: List[int] = betterproto.uint32_field(1)
    crc: int = betterproto.uint32_field(2)
    count: int = betterproto.uint32_field(3)


@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableMapValuesEntry(
    betterproto.Message
):
    key: int = betterproto.uint32_field(1)
    value: "CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableEntry" = (
        betterproto.message_field(2)
    )


@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseSequenceTableMapMappingsEntry(
    betterproto.Message
):
...
@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseAppInfo(betterproto.Message):
    country_allow: str = betterproto.string_field(1)
    country_deny: str = betterproto.string_field(2)
    platform_win: bool = betterproto.bool_field(3)
    platform_mac: bool = betterproto.bool_field(4)
    platform_linux: bool = betterproto.bool_field(5)
    adult_violence: bool = betterproto.bool_field(6)
    adult_sex: bool = betterproto.bool_field(7)


@dataclass
class CMsgSteamLearn_InferenceMetadata_ResponseAppInfoEntry(betterproto.Message):
    key: int = betterproto.uint32_field(1)
    value: "CMsgSteamLearn_InferenceMetadata_ResponseAppInfo" = (
        betterproto.message_field(2)
    )
...
@dataclass
class CMsgSteamLearn_InferenceBackend_ResponseSequence(betterproto.Message):
    value: List[float] = betterproto.float_field(1)
...
class CMsgSteamLearn_InferenceBackend_ResponseMutliBinaryCrossEntropyOutput(
    ...
    value_sequence: List[
        "CMsgSteamLearn_InferenceBackend_ResponseSequence"
    ] = betterproto.message_field(3)
